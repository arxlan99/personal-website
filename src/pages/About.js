      ...
      <CardContainer>
        ...
        <div data-aos="zoom-in-up">
          <PersonalCard>
            ...
            <p>
              Hello 👋 ! I'm <CustomizeText>John</CustomizeText>, a Frontend
              developer and indie maker from Turkey. I work with React.js, React
              Native, Node.js and a laptop 🙂
            </p>
          </PersonalCard>
        </div>
        <div>
        ...
        <div data-aos="zoom-in-up">
          <SkilsCard>
            <h2>Skills</h2>
            <p>
              My name is <CustomizeText>John,</CustomizeText> but my friends
              call me John.
            </p>
            <p>
